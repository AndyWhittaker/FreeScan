...
#pragma once
#endif // _MSC_VER > 1000
// GM1994CamaroZ28Protocol.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CGM1994CamaroZ28Protocol window
...
class CGM1994CamaroZ28Protocol : public CGM1994CamaroZ28Parser
{
// Construction
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(CGM1994CamaroZ28Protocol)
	public:
...
// Implementation
public:
	HWND Init(CSupervisor* pSupervisor, CSerialPort* pcom, CWnd* pParentWnd, CStatusDlg* pStatusDlg);// Initialises GM1994CamaroZ28Protocol
...
protected:
	//{{AFX_MSG(CGM1994CamaroZ28Protocol)
